...
#import "RNDMutableMultiValuePredicateBinderTemplate.h"

@interface RNDMutableMultiValuePredicateBinderTemplate ()

@property (nonnull, strong, readonly) NSMutableArray<RNDMutableBindingTemplate *> * bindingArray;

@end

@implementation RNDMutableMultiValuePredicateBinderTemplate
