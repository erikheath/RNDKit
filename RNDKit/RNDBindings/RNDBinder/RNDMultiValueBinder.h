...
/**
 The RNDMultiValueBinder enables the reading of values from multiple model objects that conform to RNDObservable and the subsequent generation of a boolean value based on the logical AND'ing or OR'ing of those values.
