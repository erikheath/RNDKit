//
//  RNDMutableMultiValueArgumentBinderTemplate.m
//  RNDKit
//
...
#import "RNDMutableMultiValueArgumentBinderTemplate.h"

@interface RNDMutableMultiValueArgumentBinderTemplate ()

@property (nonnull, strong, readonly) NSMutableArray<RNDMutableBindingTemplate *> * bindingArray;

@end

@implementation RNDMutableMultiValueArgumentBinderTemplate
